...
enum EstadoJornada {
  ...
  String get valorApi {
    switch (this) {
      case EstadoJornada.pendiente:
        return 'pendiente';
      case EstadoJornada.enCurso:
        return 'en_curso';
      case EstadoJornada.finalizada:
        return 'finalizada';
    }
  }

  static EstadoJornada fromApi(String valor) {
    return EstadoJornada.values.firstWhere(
      (e) => e.valorApi == valor,
      orElse: () => EstadoJornada.pendiente,
    );
  }
}
...
class Jornada {
  ...
  factory Jornada.fromJson(Map<String, dynamic> json) {
    return Jornada(
      ...
      estado: EstadoJornada.fromApi(json['estado'] as String? ?? 'pendiente'),
    );
  }
}
